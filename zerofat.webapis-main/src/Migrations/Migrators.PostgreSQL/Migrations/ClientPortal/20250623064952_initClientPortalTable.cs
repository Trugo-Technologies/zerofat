        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientAllergicIds = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    ...
                    CurrentWeightInKG = table.Column<double>(type: "double precision", nullable: true),
                    TargetWeightInKG = table.Column<double>(type: "double precision", nullable: true),
                    DietitianGoal = table.Column<int>(type: "integer", nullable: false),
                    ActivityValue = table.Column<double>(type: "double precision", nullable: false),
                    ClientSubscriptionId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    TimeToReachGoalInDays = table.Column<int>(type: "integer", nullable: false),
                    NeededCaloriesToReachGoal = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedemptionsUsed = table.Column<int>(type: "integer", nullable: false),
                    MaxRedemptionsPerClient = table.Column<int>(type: "integer", nullable: false),
                    FirstTimeClientsOnly = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedByName = table.Column<string>(type: "text", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetWeightInKG = table.Column<double>(type: "double precision", nullable: true),
                    DietitianGoal = table.Column<int>(type: "integer", nullable: false),
                    HeightMeasurement = table.Column<int>(type: "integer", nullable: true),
                    WeightMeasurement = table.Column<int>(type: "integer", nullable: true),
                    TargetWeightMeasurement = table.Column<int>(type: "integer", nullable: true),
                    ActivityValue = table.Column<double>(type: "double precision", nullable: false),
                    PhysicalActivityLevelId = table.Column<Guid>(type: "uuid", nullable: false),
                    BMI = table.Column<double>(type: "double precision", nullable: false),
                    BMR = table.Column<double>(type: "double precision", nullable: false),
                    BodyFat = table.Column<double>(type: "double precision", nullable: false),
                    TDEE = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullAddressEn = table.Column<string>(type: "text", nullable: true),
                    FullAddressAr = table.Column<string>(type: "text", nullable: true),
                    ...
                    NotesFromZeroFat = table.Column<string>(type: "text", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedByName = table.Column<string>(type: "text", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedDeliveryDays = table.Column<int[]>(type: "integer[]", nullable: false),
                    PreferredDeliveryTime = table.Column<int>(type: "integer", nullable: false),
                    TotalCost = table.Column<decimal>(type: "numeric", nullable: false),
                    AverageCalories = table.Column<decimal>(type: "numeric", nullable: false),
                    PaymentQuickLink = table.Column<string>(type: "text", nullable: true),
                    ...
                    IsAutoRenewalEnabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCaloriesConsumed = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DiscountRuleId = table.Column<Guid>(type: "uuid", nullable: true),
                    ClientId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCutlery = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    TotalCarbohydrates = table.Column<double>(type: "double precision", nullable: false),
                    TotalProteins = table.Column<double>(type: "double precision", nullable: false),
                    DailySelectionStatus = table.Column<int>(type: "integer", nullable: false),
                    ReplacementDate = table.Column<DateOnly>(type: "date", nullable: true),
                    MealPlanId = table.Column<Guid>(type: "uuid", nullable: false),
                    ClientSubscriptionId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedByName = table.Column<string>(type: "text", nullable: true),
                    DeletedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    ClientOrderItems = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    QuantityPerDay = table.Column<int>(type: "integer", nullable: false),
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    MealTypeNameEn = table.Column<string>(type: "text", nullable: true),
                    MealTypeNameAr = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DailyHealthLogId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CalorieRecord_Calories = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    ProteinInGrams = table.Column<double>(type: "double precision", nullable: true),
                    CarbsInGrams = table.Column<double>(type: "double precision", nullable: true),
                    FatInGrams = table.Column<double>(type: "double precision", nullable: true),
                    RecordedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    MealTime = table.Column<TimeOnly>(type: "time(0) without time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Date = table.Column<DateOnly>(type: "date", nullable: false),
                    MealSelectionType = table.Column<int>(type: "integer", nullable: false),
                    ...
                    PriceAdjustmentReason = table.Column<string>(type: "text", nullable: true),
                    TotalCalories = table.Column<double>(type: "double precision", nullable: false),
                    TotalFats = table.Column<double>(type: "double precision", nullable: false),
                    TotalCarbohydrates = table.Column<double>(type: "double precision", nullable: false),
                    TotalProteins = table.Column<double>(type: "double precision", nullable: false),
                    CustomeMealName = table.Column<string>(type: "text", nullable: true),
                    ...
                    DailySelectionId = table.Column<Guid>(type: "uuid", nullable: false),
                    ClientSubscriptionId = table.Column<Guid>(type: "uuid", nullable: false),
                    ClientId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedByName = table.Column<string>(type: "text", nullable: true),
