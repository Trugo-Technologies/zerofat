...
namespace ZeroFat.GymUp.Infrastructure.Persistence; 
internal sealed class WorkoutRepository<T>(GymUpContext context) : RepositoryBase<T>(context), IReadRepository<T>, IRepository<T>
