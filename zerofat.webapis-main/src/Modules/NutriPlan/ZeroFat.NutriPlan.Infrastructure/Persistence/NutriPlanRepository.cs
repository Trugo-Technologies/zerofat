...
namespace ZeroFat.NutriPlan.Infrastructure.Persistence; 
internal sealed class NutriPlanRepository<T>(NutriPlanContext context) : RepositoryBase<T>(context), IReadRepository<T>, IRepository<T>
