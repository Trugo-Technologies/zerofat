...
namespace ZeroFat.Users.Infrastructure.Persistence; 
internal sealed class UsersRepository<T>(UsersContext context) : RepositoryBase<T>(context), IReadRepository<T>, IRepository<T>
