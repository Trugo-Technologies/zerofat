...
namespace UPC.WebApis.Infrastructure.BackgroundJobs;

public class IPJobActivator : JobActivator
{
    private readonly IServiceScopeFactory _scopeFactory;

    public IPJobActivator(IServiceScopeFactory scopeFactory) =>
    ...
    private sealed class Scope : JobActivatorScope, IServiceProvider
    {
        ...
        private void ReceiveParameters()
        {
            ...
            {
                /// _scope.ServiceProvider.GetRequiredService<ICurrentUserInitializer>().SetCurrentUserId(userId);
            }
        }
