...
namespace ZeroFat.Infrastructure.Core.Persistence; 
internal sealed class CoreRepository<T>(CoreContext context) : RepositoryBase<T>(context), IReadRepository<T>, IRepository<T>
