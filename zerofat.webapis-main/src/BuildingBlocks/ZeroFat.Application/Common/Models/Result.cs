...
public class ErrorResult : Result<string>
{
...
public class Result<T> : Result, IResult<T>
{
    ...
    public static ErrorResult ReturnError(string message)
    {
    ...
    public static ErrorResult ReturnError(List<string> messages)
    {
    ...
    public static Task<ErrorResult> ReturnErrorAsync(string message)
    {
    ...
    public static Task<ErrorResult> ReturnErrorAsync(List<string> messages)
    {
